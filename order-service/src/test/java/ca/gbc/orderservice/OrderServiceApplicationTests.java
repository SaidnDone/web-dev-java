...
class OrderServiceApplicationTests extends AbstractContainerBaseTest{
	...
	private OrderLineItemDto getOrderLineITtemDto(String sku){
	...
	private OrderRequest getOrderRepository(String sku){
		List<OrderLineItemDto> orderLineItemDtoList = new ArrayList<>();
		orderLineItemDtoList.add(getOrderLineITtemDto(sku));
	...
	void placeOrder() throws Exception {
		InventoryResponse inventoryResponse = new InventoryResponse(TEST_SKU_CODE,
				true);
